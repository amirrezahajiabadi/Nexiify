...
PROJECTS = [
    ...
    {
        "order": 7,
        "title": "اتوماسیون فروش با n8n",
        "icon": "⚡",
        "categories": "automation",
        "category_label": "اتوماسیون",
        "short_description": "پکیج آماده‌ی اتوماسیون فروش: اتصال فرم‌ها، CRM و اطلاع‌رسانی خودکار با n8n",
        "description": "پکیج آماده‌ی اتوماسیون که فرم‌های وب را به CRM و کانال‌های اطلاع‌رسانی متصل می‌کند.",
        "tags": ["n8n", "Webhooks", "REST API", "Telegram Bot"],
        "duration": "۲ هفته",
        "role": "Automation Engineer",
        "status": "آماده تحویل",
        "github_url": GITHUB,
        "gradient": "135deg,#164e63,#06b6d4",
    },
    {
        "order": 4,
